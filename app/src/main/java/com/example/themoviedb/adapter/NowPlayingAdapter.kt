...
class NowPlayingAdapter(var nowPlayingList: List<Result> = ArrayList()):RecyclerView.Adapter<NowPlayingAdapter.NowPlayingViewHolder>() {
    ...
    private var clickListener: NowPlayingClickListener? =null
    fun setOnClickListener(clickListener: NowPlayingClickListener) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NowPlayingViewHolder {
        var viewHolder =
            LayoutInflater.from(parent.context).inflate(R.layout.now_playing_item, parent, false)
